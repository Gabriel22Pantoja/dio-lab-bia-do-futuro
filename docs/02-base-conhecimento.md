...
>  (3) criar um exemplo de contexto formatado pa incluir no prompt.
...
| `produtos_financeiros.json` | JSON | Conhecer os produtos disponível para que eles possam ser ensinados ao cliente. |
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar produtos financeiros que eu conheço. Assim, poderei validar as respostas do Edit de forma mais assertiva.
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "Dividend Yield (DY) costuma ficar entre 6% e 12% ao ano.",
    "aporte_minimo": 100.00,
...
- Nome: João Silva
- Perfil: Moderado
- Objetivo: Contruir reserva de emergência
- Reserva Atuak: R$10.000 (meta: R$ 15.000)
...
- LCI/LCA (risco baixo)
- Fundo Imobiliária -FII (risco médio)
